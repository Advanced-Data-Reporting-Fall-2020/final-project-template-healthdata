...
>>>>>>> cdfbb2c21fa0cf8dca92bda7968b5edd99f380bf
library(gsheet)
...
left_join(CompiledLHDExpenditures, infl_rates, by=c("year"="year")) %>%
  ...
  select(year, lhd_name, lhd_area_type, county_name, population, expenditures, expenditures_infl, expenditures_per_capita = per_capita_spending, expenditures_infl_per_capita)
