...
```
At the state level in 2018, North Carolina spends less per person than all but 12 states. It spends about $72 per person. 
...
On top of the 27% drop at the state level, county-level spending also dropped 15%.
...
```{r}
#Creating a dataframe to better examine the changes in FTEs from 2007-2017.
nc_fte_change <- 
...
* Avery, Mitchel, Yancey (Toe River) 
* Catawba
