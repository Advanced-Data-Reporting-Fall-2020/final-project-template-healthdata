...
Create a new df that just has the year, lhd name, and fte per capita
```{r}
...
*EDIT* 2009-2017 fte per capita change over time for our sample size
```{r}
